/**
 * Tool for reading JavaScript code from the current vibe under edit
...
class ReadJSTool extends AgenticTool {
  ...
  constructor(hackService) {
    ...
    super(
      "read_js",
      "Read JavaScript code from the current vibe under edit. Returns the current JS code and optionally metadata about it.",
      schema
    );
  ...
  /**
   * Get user-friendly action message for JS reading
   * @returns {string} Action message
   */
  getActionMessage() {
    return "Reading existing JavaScript";
  }

  /**
   * Get user-friendly completion message for JS reading
   * @returns {string} Completion message
   */
  getCompletionMessage() {
    return "JavaScript code analyzed";
  }

  /**
   * Get user-friendly error message for JS reading failures
   * @param {string} error - The actual error
   * @returns {string} Error message
   */
  getErrorMessage(error) {
    return `Failed to read JavaScript: ${error}`;
  }
