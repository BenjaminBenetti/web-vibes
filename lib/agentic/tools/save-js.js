/**
 * Tool for saving JavaScript code to the current vibe under edit
...
class SaveJSTool extends AgenticTool {
  ...
  constructor(hackService) {
    ...
    super(
      "save_js",
      "Save JavaScript code to the current vibe under edit. Can either replace existing JS code or append to it.",
      schema
    );
  ...
  /**
   * Get user-friendly action message for JS saving
  ...
  /**
   * Get user-friendly completion message for JS saving
   * @returns {string} Completion message
   */
  getCompletionMessage() {
    return "JavaScript code updated";
  }

  /**
   * Get user-friendly error message for JS saving failures
   * @param {string} error - The actual error
   * @returns {string} Error message
   */
  getErrorMessage(error) {
    return `Failed to update JavaScript: ${error}`;
  }
}
