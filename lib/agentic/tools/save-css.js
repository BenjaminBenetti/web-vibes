...
class SaveCSSTool extends AgenticTool {
  ...
  /**
   * Get user-friendly action message for CSS saving
  ...
  /**
   * Get user-friendly completion message for CSS saving
   * @returns {string} Completion message
   */
  getCompletionMessage() {
    return "CSS styles updated";
  }

  /**
   * Get user-friendly error message for CSS saving failures
   * @param {string} error - The actual error
   * @returns {string} Error message
   */
  getErrorMessage(error) {
    return `Failed to update CSS: ${error}`;
  }
}
