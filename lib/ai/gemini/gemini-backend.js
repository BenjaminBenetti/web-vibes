...
class GeminiBackend extends AIBackend {
  ...
  async initialize(credentials) {
    try {
      ...
      if (credentials && typeof credentials === 'object' && credentials.constructor && credentials.constructor.name === 'GeminiSettings') {
        apiKey = credentials.apiKey;
        // In the future, extract more fields for backend config if needed
      }
