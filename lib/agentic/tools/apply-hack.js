...
class ApplyHackTool extends AgenticTool {
  ...
  constructor(hackService) {
    ...
    super(
      "apply_hack",
      "Apply the current vibe/hack to the active webpage. This will inject the vibe's CSS and JavaScript code into the page so the user can see the changes in real-time.",
      schema
    );
