...
class ReadCSSTool extends AgenticTool {
  ...
  /**
   * Get user-friendly action message for CSS reading
   * @returns {string} Action message
   */
  getActionMessage() {
    return "Reading existing CSS";
  }

  /**
   * Get user-friendly completion message for CSS reading
   * @returns {string} Completion message
   */
  getCompletionMessage() {
    return "CSS code analyzed";
  }

  /**
   * Get user-friendly error message for CSS reading failures
   * @param {string} error - The actual error
   * @returns {string} Error message
   */
  getErrorMessage(error) {
    return `Failed to read CSS: ${error}`;
  }
}
