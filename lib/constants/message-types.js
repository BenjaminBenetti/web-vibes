...
/**
 * Message types for CSP and service worker operations
 */
const CSP_MESSAGES = {
  /** Check if CSP busting is enabled for a hostname */
  CHECK_CSP_ENABLED: "CHECK_CSP_ENABLED",

  /** Check if service worker blocking is enabled for a hostname */
  CHECK_SERVICE_WORKER_BLOCKING_ENABLED:
    "CHECK_SERVICE_WORKER_BLOCKING_ENABLED",

  /** Toggle CSP busting on/off */
  TOGGLE_CSP_BUSTING: "TOGGLE_CSP_BUSTING",

  /** Toggle service worker blocking on/off */
  TOGGLE_SERVICE_WORKER_BLOCKING: "TOGGLE_SERVICE_WORKER_BLOCKING",
};
