...
function createWebVibesLibrary() {
  ...
  return {
    ...
    createAgenticService: (aiService, hackService, settingsService) => {
      if (!settingsService) {
        throw new Error(
          "settingsService is required for createAgenticService"
        );
      }
      if (typeof createAgenticService === "function") {
        return createAgenticService(aiService, hackService, settingsService);
      }
      ...
      return new AgenticService(aiService, tools, settingsService);
    },
